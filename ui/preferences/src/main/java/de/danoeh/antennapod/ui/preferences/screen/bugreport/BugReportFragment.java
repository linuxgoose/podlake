...
public class BugReportFragment extends AnimatedFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewBinding.openForumButton.setOnClickListener(v ->
                IntentUtils.openInBrowser(requireContext(), "https://github.com/linuxgoose/podlake-android/issues?q=is%3Aissue"));
        viewBinding.openGithubButton.setOnClickListener(v ->
                IntentUtils.openInBrowser(requireContext(), "https://github.com/linuxgoose/podlake-android/issues/new/choose"));
